        ...
        success:function(result){
            for(var i = 0; i< result.length; i++)
            {
                ...
                $("#tblCategory tbody").append("<tr bgcolor='"+ bgcolor +"' id='"+ result[i].id +"' name='"+ result[i].name +"'>"+
                                                ...
                                                "<td><a class='remove' href='/meh-hil/Application/admin/deleteCategory.php?id="+result[i].id+"' title='Hapus Kategori'>X</a></td>"+
                                                "</tr>");
            }
...
function updateCategory(){
    ...
    $(".container-page").append("<div id='divUpdateCateogry'><form action='/meh-hil/Application/admin/updateCategory.php' method='POST'><table cellpadding='5px' cellspacing='0'>"+
...
function AddCategory(){
    if($("#divUpdateCateogry").length > 0) $("#divUpdateCateogry").remove();
    $(".container-page").append("<div id='divUpdateCateogry'><form action='/meh-hil/Application/admin/addCategory.php' method='POST'><table cellpadding='5px' cellspacing='0'>"+
