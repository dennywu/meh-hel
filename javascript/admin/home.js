...
function showPenyewaan(){
    $.ajax({
        type:"GET",
        url : "/meh-hil/Application/admin/getAllRental.php",
        dataType: "json",
...
function showDetail(){
    ...
    $.ajax({
        type: 'GET',
        url: '/meh-hil/Application/admin/getDetailRentalById.php?id='+id,
        dataType: 'json',
...
function showDetailCallBack(data){
    console.log(data);
    $("#tblPenyewaan").hide();
    $(".container-page").load('/meh-hil/views/admin/detailRental.html');
    var totalDenda= 0;
    setTimeout(function(){
...
function changeStatus(){
    ...
    $.ajax({
        type:'POST',
        url:'/meh-hil/Application/admin/updateStatus.php',
